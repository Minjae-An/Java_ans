...
class MainFrame4 extends JFrame{
    ...
    private JCheckBox[] userChoice=new JCheckBox[7];
    ...
    public MainFrame4(){
        ...
        calcBtn.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e){
                ...
                for(int i=0; i<resultFields.length; i++){
                    if(i!=resultFields.length-1 && !userChoice[i].isSelected()){
        ...
        for(int i=0; i<resultFields.length; i++){
            ...
            if(i==resultFields.length-1) break;

            userChoice[i]=new JCheckBox();
            userChoice[i].setSelected(true);
            userChoice[i].setLocation(210, 50+20*i);
            userChoice[i].setSize(20, 20);
            c.add(userChoice[i]);
        }
